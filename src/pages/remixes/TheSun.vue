<template>
  <div className="flex flex-col min-h-screen overflow-hidden">
    ...
    <main class="grow">
      ...
      <ReleaseDescription>
        You and me. The sun and an overwhelming rage looming. House beats, funky synths, 8-bit computer noises. Fractured voices, decomposed to be re-combined along multiple layers. Rising, then falling. Like the sun broken into a pouring rain of cold numbers.
      </ReleaseDescription>

      <InfoBox title="Original version" icon="ph-copyright-fill ph-2x" :borderColor="getCurrentCategory.color.border">
          <ul class="text-lg">
           <li>
              <p class="text-lg pb-4 text-slate-500"><EmDashListStyle /><a class="text-slate-800 hover:underline" target="_blank" href="https://www.youtube.com/watch?v=q6dcCAKhSNc">Original tune</a> composed and recorded by Big Charlie, featured on the album <a class="text-slate-800 hover:underline" target="_blank" href="https://open.spotify.com/album/2k9xp2qqiZdErwmEvJnKsf">Too Little Too Late</a>, published by Snowy Peach Records © 2011.</p>
            </li>
          </ul>
        </InfoBox>
      ...
      <InfoBox title="Samples" icon="ph-music-notes-plus-fill ph-2x" :borderColor="getCurrentCategory.color.border">
          <ul class="text-lg">
           <li>
              <p class="text-lg pb-4 text-slate-500"><EmDashListStyle />Drums sample from <a class="text-slate-800 hover:underline" target="_blank" href="https://k7records.bandcamp.com/track/numbers">Numbers</a> by Bookashade, originally appearing on the album <a class="text-slate-800 hover:underline" target="_blank" href="https://k7records.bandcamp.com/album/dj-kicks-the-exclusives-2">DJ Kicks (The Exclusives)</a>, published by !K7 Records © 2012.</p>
            </li>
          </ul>
        </InfoBox>
