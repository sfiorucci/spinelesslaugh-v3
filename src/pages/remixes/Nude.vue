<template>
  <div className="flex flex-col min-h-screen overflow-hidden">
    ...
    <main class="grow">
      ...
      <ReleaseDescription>
        Don't get any big ideas: they're gonna glitch into disjointed arpeggios. Beauty sampled asynchronously, but there's something missing, something's off the rails. You might seem to find it, but it' already gone. So, if we all have to go to hell, let's make sure our minds think dirty.
      </ReleaseDescription>

      <InfoBox title="Original version" icon="ph-copyright-fill ph-2x" :borderColor="getCurrentCategory.color.border">
          <ul class="text-lg">
           <li>
              <p class="text-lg pb-4 text-slate-500"><EmDashListStyle /><a class="text-slate-800 hover:underline" target="_blank" href="https://www.youtube.com/watch?v=BbWBRnDK_AE">Original tune</a> composed and recorded by Radiohead, featured on the album <a class="text-slate-800 hover:underline" target="_blank" href="https://open.spotify.com/album/5vkqYmiPBYLaalcmjujWxK">In Rainbows</a>, published by XL Recordings © 2007.</p>
            </li>
          </ul>
        </InfoBox>
      ...
      <InfoBox title="Samples" icon="ph-music-notes-plus-fill ph-2x" :borderColor="getCurrentCategory.color.border">
          <ul class="text-lg">
           <li>
              <p class="text-lg pb-4 text-slate-500"><EmDashListStyle />Noise samples from <a class="text-slate-800 hover:underline" target="_blank" href="https://www.youtube.com/watch?v=SuXd1niwoU8">Postfabric</a> by Alva Noto, originally appearing on the album <a class="text-slate-800 hover:underline" target="_blank" href="https://open.spotify.com/album/6LcD8NBUmNzwBPWdVG2seH">Transvision</a>, published by NOTON Records © 2004.</p>
            </li>
          </ul>
        </InfoBox>
