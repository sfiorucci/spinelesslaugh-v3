    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="flex items-center justify-between h-16 md:h-36">
        ...
        <div class="shrink-0 mr-4 md:mt-4">
          <!-- Logo -->
          <router-link id="logo" class="group flex flex-row" to="/" aria-label="Spineless Laugh">
            <img src="../../images/logo-gradient.svg" id="glyph" class="w-14 transition duration-500 ease-in-out delay-100 hover:rotate-180" alt="Logo" />
            <div id="logotype" class="text-3xl pl-4 pt-2 transition.all duration-700 ease-in-out delay-150 font-bold font-hkgrotesk text-slate-800 hover:tracking-wider">Spineless Laugh</div>
